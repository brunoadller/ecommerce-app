        ...
        <div className="row">
          <div className="col-4">
            ...
            <div>
              ...
              <a href="tel:+91 8264954234" className='mt-3 d-block mb-2 text-white'>tel:+91 8264954234</a>
              <a href="adller676@gmail.com" className='mt-2 d-block mb-2 text-white'>adller676@gmail.com</a>
          ...
          <div className="col-3">
            ...
            <div>
              ...
              <Link className = "text-white py-2 mb-1">Refud Policy</Link>
          ...
          <div className="col-2">
            ...
            <div className='footer-link d-flex flex-column'>
              <Link className = "text-white py-2 mb-1">Acessories</Link>
